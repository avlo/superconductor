...
public interface SubscriberFilterEventRepository extends JpaRepository<SubscriberFilterEvent, Long> {
  ...
  @Query("SELECT new com.prosilion.superconductor.entity.EventStandardTagEntity(b.key, b.idEvent, b.marker) from EventEntityEventTagEntity b where b.id = :eventEntityId")
  List<EventTagEntity> findBaseTagsByEventEntityId(Long eventEntityId);
