...
//    List<EventEntityIF> eventsByPublicKey = eventEntityService.getEventsByPublicKey(textNoteEvent.getPublicKey());
//    assertTrue(
//        eventsByPublicKey
//            .stream().anyMatch(eventEntity ->
//                eventEntity.getPubKey().equals(textNoteEvent.getPublicKey().toHexString())));
//  }
//
//  @Test
//  void saveAndGetEventWithGeohash() {
//    EventEntityIF savedEvent = eventEntityService.getEventById(savedEventId).orElseThrow();
//
