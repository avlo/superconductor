...
class EventMessageIT {
  ...
  public void setup() {
    ...
    reqStompClient.getWebSocketClient().execute(new ReqMessageSocketHandler(), websocketUrl, "");
    ...
    eventStompClient.getWebSocketClient().execute(new EventMessageSocketHandler(), websocketUrl, "");
  }
