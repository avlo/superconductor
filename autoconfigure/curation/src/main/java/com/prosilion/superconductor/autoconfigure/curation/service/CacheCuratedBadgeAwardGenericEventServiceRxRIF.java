...
public interface CacheCuratedBadgeAwardGenericEventServiceRxRIF {
  ...
  Optional<CuratedBadgeAwardGenericEvent> getByDirect(@NonNull EventTag eventTag);
  Optional<CuratedBadgeAwardGenericEvent> getByExpanded(EventTag eventTag);
}
