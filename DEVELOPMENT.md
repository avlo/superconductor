...
### 3.  Run locally as executable jar
    ...
    $ cd <your_git_home_dir>/superconductor
    $ java -jar superconductor/target/superconductor-1.13.1.war  

----

### 4.  Run using pre-existing local application-server-container instance

    $ cp <your_git_home_dir>/superconductor/superconductor/target/superconductor-1.13.1.war <your_container/instance/deployment_directory>
