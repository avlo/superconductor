...
@ActiveProfiles("test")
class RequestThenEventThenUpdatedRequestReceivesNewEventIT extends BaseRequestThenEventThenUpdatedRequestReceivesNewEventIT {
  private final String eventId_1;

  public RequestThenEventThenUpdatedRequestReceivesNewEventIT(@NonNull @Value("${superconductor.relay.url}") String relayUrl) {
    super(relayUrl);
  ...
  @Test
  void testRequestThenEventThenUpdatedRequestReceivesNewEvent() throws NostrException {
