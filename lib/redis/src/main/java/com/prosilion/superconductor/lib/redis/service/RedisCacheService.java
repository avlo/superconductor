...
//    T baseEventFromEntityIF = createBaseEventFromEntityIF(eventNosqlEntityIF);
    BaseEvent baseEventFromEntityIF = createBaseEventFromEntityIF(eventNosqlEntityIF).orElseThrow();
  ...
  public List<? extends BaseEvent> getEventsByKindAndPubKeyTag(
    ...
    List<? extends BaseEvent> collect = eventsByKindAndPubKeyTag.stream().map(this::createBaseEventFromEntityIF).flatMap(Optional::stream).toList();
    return collect;
  }
  ...
  public List<? extends BaseEvent> getEventsByKindAndIdentifierTag(
    ...
    List<? extends BaseEvent> list = eventsByKindAndIdentifierTag.stream().map(this::createBaseEventFromEntityIF).flatMap(Optional::stream).toList();
    return list;
  }
  ...
  public List<? extends BaseEvent> getEventsByKindAndPubKeyTagAndAddressTag(
    ...
    List<? extends BaseEvent> list = eventsByKindAndPubKeyTagAndAddressTag.stream().map(this::createBaseEventFromEntityIF).flatMap(Optional::stream).toList();
    return list;
  }
  ...
  public List<? extends BaseEvent> getEventsByKindAndPubKeyTagAndIdentifierTag(
    ...
    List<? extends BaseEvent> list = eventsByKindAndPubKeyTagAndIdentifierTag.stream().map(this::createBaseEventFromEntityIF).flatMap(Optional::stream).toList();
    return list;
  }
  ...
  public List<? extends BaseEvent> getEventsByKindAndAuthorPublicKeyAndIdentifierTag(Kind kind, PublicKey authorPublicKey, IdentifierTag identifierTag) {
    ...
    List<? extends BaseEvent> list = eventsByKindAndAuthorPublicKeyAndIdentifierTag.stream().map(this::createBaseEventFromEntityIF).flatMap(Optional::stream).toList();
    return list;
  }
