...
public class BadgeDefinitionH2dbTestConfig {
  ...
  BadgeDefinitionGenericEvent badgeDefinitionUpvoteEvent(
    ...
    return new BadgeDefinitionGenericEvent(superconductorInstanceIdentity, new IdentifierTag(DataLoaderJpaIF.UNIT_UPVOTE), new Relay(superconductorRelayUrl));
  }
  ...
  BadgeDefinitionGenericEvent badgeDefinitionDownvoteEvent(
      @NonNull Identity superconductorInstanceIdentity,
      @NonNull String superconductorRelayUrl) {
    return new BadgeDefinitionGenericEvent(superconductorInstanceIdentity, new IdentifierTag(DataLoaderJpaIF.UNIT_DOWNVOTE), new Relay(superconductorRelayUrl));
  }
}
