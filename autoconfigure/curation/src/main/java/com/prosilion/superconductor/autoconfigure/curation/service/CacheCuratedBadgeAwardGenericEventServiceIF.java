...
public interface CacheCuratedBadgeAwardGenericEventServiceIF extends
   CacheTagMappedEventServiceIF<CuratedBadgeAwardGenericEvent, EventTag>,
   CacheCuratedEventServiceIF<CuratedBadgeAwardGenericEvent>,
   CacheAddressableEventServiceIF<CuratedBadgeAwardGenericEvent, EventTag> {
