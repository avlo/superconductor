...
@Slf4j
public abstract class AbstractCacheBadgeAwardCanonicalEventMessageSupplierLocalListIT extends AbstractBaseCacheBadgeAwardCanonicalEventMessageListIT {
  protected AbstractCacheBadgeAwardCanonicalEventMessageSupplierLocalListIT(
     @NonNull Identity superconductorInstanceIdentity,
     @NonNull String relayUrl,
     CacheServiceIF cacheServiceIF) throws NostrException {
    super(superconductorInstanceIdentity, relayUrl, relayUrl, cacheServiceIF);
  }
...
//  f3d99dca62e39e68bd54dcc5b95f541ee5a681d25fc7742b4aef9d1e14620fe9
  ...
  protected void validatePersistedCurationSetsBadgeDefinitionEvents(List<BadgeAwardCanonicalEvent> badgeAwardUpvoteEvents) {
    ...
    Set<String> sanityCheckCurationSetsBadgeDefinitionEventIds = sanityCheckReturnedBadgeDefinitionEvents.stream()
       .map(EventIF::getId)
...
//    IdentifierTag identifierTag = upvoteIdentifierTag;
  ...
  protected BadgeAwardCanonicalEvent createAwardEventWithRelayTagDefinitionEventWithRelayTag() {
    return new BadgeAwardCanonicalEvent(
       submitter,
       recipient.getPublicKey(),
       new BadgeDefinitionGenericEvent(
  ...
  protected BadgeAwardCanonicalEvent createAwardEventWithoutRelayTagDefinitionEventWithRelayTag() {
    return new BadgeAwardCanonicalEvent(
       submitter,
       recipient.getPublicKey(),
       new BadgeDefinitionGenericEvent(
  ...
  protected BadgeAwardCanonicalEvent createAwardEventWithRelayTagDefinitionEventWithoutRelayTag() {
    return new BadgeAwardCanonicalEvent(
       submitter,
       recipient.getPublicKey(),
       new BadgeDefinitionGenericEvent(
  ...
  protected BadgeAwardCanonicalEvent createAwardEventWithoutRelayTagDefinitionEventWithoutRelayTag() {
    return new BadgeAwardCanonicalEvent(
       submitter,
       recipient.getPublicKey(),
       new BadgeDefinitionGenericEvent(
