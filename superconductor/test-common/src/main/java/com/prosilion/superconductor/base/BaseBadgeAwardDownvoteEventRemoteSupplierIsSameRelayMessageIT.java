...
@Slf4j
public abstract class BaseBadgeAwardDownvoteEventRemoteSupplierIsSameRelayMessageIT {
  ...
  protected BaseBadgeAwardDownvoteEventRemoteSupplierIsSameRelayMessageIT(
