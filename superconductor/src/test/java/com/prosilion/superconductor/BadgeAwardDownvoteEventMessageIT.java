...
public class BadgeAwardDownvoteEventMessageIT {
            ...
            .send(
                new EventMessage(
                    new GenericEventKindDto(
                        downvoteBadgeDefinitionEvent).convertBaseEventToGenericEventKindIF()))
            .getFlag());
  ...
  void testValidExistingEventThenAfterImageReputationRequest() throws IOException, NostrException {
    ...
    assertEquals(TestKindType.DOWNVOTE.getName(), addressTag.getIdentifierTag().getUuid());
  }
