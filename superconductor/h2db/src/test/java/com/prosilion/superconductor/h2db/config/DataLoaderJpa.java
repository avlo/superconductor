...
public class DataLoaderJpa implements DataLoaderJpaIF {
  ...
  public DataLoaderJpa(
      ...
      @NonNull @Qualifier("badgeDefinitionVoteEvent") BadgeDefinitionGenericEvent badgeDefinitionUpvoteEvent,
      @NonNull @Qualifier("badgeDefinitionVoteEvent") BadgeDefinitionGenericEvent badgeDefinitionDownvoteEvent) {
