...
public interface CacheCuratedFormulaEventServiceIF extends
   CacheTagMappedEventServiceIF<CuratedFormulaEvent, AddressTag>,
   CacheCuratedEventServiceIF<CuratedFormulaEvent>,
   CacheAddressableEventServiceIF<CuratedFormulaEvent, AddressTag> {
