...
@Slf4j
public abstract class BaseCacheCuratedBadgeDefinitionEventWithoutRelayTagRemoteSupplierMessageIT extends BaseIntegrationTestFixtures {
  ...
  protected BaseCacheCuratedBadgeDefinitionEventWithoutRelayTagRemoteSupplierMessageIT(
