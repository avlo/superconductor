...
public interface CacheKindAddressTagServiceIF {
      List<GenericEventRecord> getDirectBy(@NonNull Kind kind, @NonNull AddressTag t);
      List<GenericEventRecord> getDirectBy(@NonNull Kind kind, @NonNull PubKeyTag pubKeyTag, @NonNull AddressTag addressTag);
