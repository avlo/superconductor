...
@Slf4j
@Nested
public abstract class BaseMultipleSubscriberClassifiedListingEventMessageIT extends AbstractMultipleSubscriber {
...
//    tags.add(T_TAG);
//
//    EventIF classifiedListingEvent = Factory.createClassifiedListingEvent(
//        IDENTITY,
//        tags,
//        content,
