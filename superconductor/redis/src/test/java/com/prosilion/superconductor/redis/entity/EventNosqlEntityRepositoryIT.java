...
class EventNosqlEntityRepositoryIT {
  ...
  public static final PublicKey PUB_KEY = Identity.generateRandomIdentity().getPublicKey();
  ...
  EventNosqlEntityRepositoryIT(EventNosqlEntityRepository eventNosqlEntityRepository) {
    ...
    assertEquals(PUB_KEY, eventNosqlEntity.getPublicKey());
  ...
  void testGetAllFields() {
    ...
    assertEquals(PUB_KEY, byEventIdString.getPublicKey());
