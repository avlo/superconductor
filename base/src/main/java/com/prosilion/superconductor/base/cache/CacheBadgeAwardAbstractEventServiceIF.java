...
public interface CacheBadgeAwardAbstractEventServiceIF<S extends AddressableEvent, T extends BadgeAwardAbstractEvent<S>, U extends ReferencedAbstractEventTag> extends CacheTagMappedEventServiceIF<T, U>, EventMaterializer<T> {
