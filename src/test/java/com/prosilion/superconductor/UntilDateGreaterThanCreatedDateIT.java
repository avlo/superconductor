...
class UntilDateGreaterThanCreatedDateIT {
  ...
  @Autowired
  UntilDateGreaterThanCreatedDateIT(@NonNull NostrRelayService nostrRelayService,
  ...
  private String createReqJson(@NonNull String uuid) {
    ...
    return "[\"REQ\",\"" + uuidKey + "\",{\"authors\":[\"000d79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984\"],\"until\": " + uuid + "}]";
  }
}
