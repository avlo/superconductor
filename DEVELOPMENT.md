...
###### build.gradle
```groovy
implementation 'com.prosilion.superconductor:superconductor-spring-boot-starter-redis:' + 1.17.2
```
</blockquote>            
        </details>
    </blockquote>
...
###### build.gradle
```groovy
implementation 'com.prosilion.superconductor:superconductor-spring-boot-starter-sqlite:' + 1.17.2
```
</blockquote>            
        </details>
    </blockquote>
...
###### build.gradle
```groovy
implementation 'com.prosilion.superconductor:superconductor-spring-boot-starter-mysql:' + 1.17.2
```
</blockquote>            
        </details>
    </blockquote>
...
###### build.gradle
```groovy
implementation 'com.prosilion.superconductor:superconductor-spring-boot-starter-h2db:' + 1.17.2
```
</blockquote>            
        </details>
    </blockquote>
...
###### build.gradle
```groovy
implementation 'com.prosilion.superconductor:superconductor-base:' + 1.17.2
```
</blockquote>            
        </details>
    </blockquote>
...
```bash
  ...
  $ java -jar -Dspring.profiles.active=local_ws superconductor/redis/target/superconductor-app-redis-1.17.2.war
```
</blockquote>
        </details>
...
```bash
  ...
  $ java -jar -Dspring.profiles.active=local_ws superconductor/sqlite/target/superconductor-app-sqlite-1.17.2.war
```
</blockquote>
        </details>
        <details><summary>microsoft</summary>
...
```bash
  ...
  $ java -jar -Dspring.profiles.active=local_ws superconductor/h2db/target/superconductor-app-h2db-1.17.2.war
```
</blockquote>
        </details>
        <details><summary>microsoft</summary>
...
```bash
  $ cp <your_git_home_dir>/superconductor/superconductor/redis/target/superconductor-app-redis-1.17.2.war <your_container/instance/deployment_directory>
```
</details>
<details>
...
```bash
  $ cp <your_git_home_dir>/superconductor/superconductor/sqlite/target/superconductor-app-sqlite-1.17.2.war <your_container/instance/deployment_directory>
```
</details>
<details>
...
```bash
  $ cp <your_git_home_dir>/superconductor/superconductor/h2db/target/superconductor-app-h2db-1.17.2.war <your_container/instance/deployment_directory>
```
</details>
<details>
...
```bash
  $ cp <your_git_home_dir>/superconductor/superconductor/mysql/target/superconductor-app-mysql-1.17.2.war <your_container/instance/deployment_directory>
```
</details>
