...
public interface FilterBiPredicate<T extends Filterable, U extends GenericEventDtoIF> extends FilterPlugin<T, U> {
  ...
  default <V extends BaseTag> List<V> getTypeSpecificTags(Class<V> tagClass, GenericEventDtoIF genericEvent) {
