...
public abstract class BaseFilterMatcherIT {
  ...
  public BaseFilterMatcherIT(FilterMatcher filterMatcher) {
  ...
  void testEquality() throws NostrException {
    ...
    EventIF event = new TextNoteEvent(identity, List.of(addressTag), "content");
